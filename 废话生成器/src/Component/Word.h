...
static string Say[] = {"拷问", "说", "苦诉", "大吼", "扯着嗓子说", "劝告", "尖叫"};

static string Question[] = {"难道", "典中典,你这种人我见得多了,你就没有考虑过",
                     "可是你就没有想过", "可是你就这么肯定", "你真是愚蠢,难道"};

static string Para[] = {"像", "犹如", "宛如", "和"};

static string Adj[] = {"绿色", "旋转", "美丽", "百年", "寒冷", "永恒",   "烧毁",
                "燃烧", "死掉", "碳色", "活泼", "静态", "强大",   "弱小",
                "沉底", "腹鳍", "冰冻", "随机", "高级", "奢侈",   "肥胖",
                "黄色", "黑色", "木制", "铁质", "纺织", "正方形", "圆形"};

static string Noun[] = {"我",         "乌鸦",       "码头",
                 "马桶",       "钻井",       "盾构机",
                 "负二次方",   "电视",       "垃圾桶",
                 "手机",       "酸液",       "大蒜",
                 "窗户",       "太阳",       "水枪",
...
static string Verb[] = {"击打", "空袭","称霸","踏破","掀翻","冰封","闪击","上",
                        "席卷","袭击", "偷袭", "爆破", "打开", "关闭","碎裂","碎裂",
                        "占领","语言攻击","冷暴力",
                 "堵塞", "杀掉", "进入", "推出", "退出", "删掉",
                 "治疗", "加热", "烧烤", "思考", "记得", "忘掉",
                 "清洗", "轰炸", "关掉", "启动", "拿起", "驾驶",
...
static string Vebi[] = {"抽搐",   "走路", "死掉", "卡机", "排泄", "自爆", "发癫",
                 "害怕",   "思考", "生存", "活着", "呼吸", "睡觉", "起飞",
                 "发疯",   "大哭", "狂笑", "狂笑", "扭曲", "分解", "结合",
                 "融化",   "萎缩", "膨胀", "跳舞", "生锈", "氧化", "游泳",
                 "嗯嗯了", "自裁", "中风"};

static string Ten[] = {"十分", "很", "究极", "非常","十分甚至九分"};

static string Adv1[] = {"忘记", "原地", "不断",       "突然",        "进一步",
                 "逐渐", "悄悄", "把屁股翘起来","站在这里","还没睡醒"};

static string Adv2[] = {"无奈", "失望", "愤怒", "开心",
                 "用力", "绝望", "懊恼", "心不在焉","头也不回"};

static string Prep[] = {"中", "里面", "外面", "上面", "下面", "内部"};
